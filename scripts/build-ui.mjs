...
const [html, css, appJs, mapBytes, reimuSpriteBytes, mainHouseBytes, hostShellSource] = await Promise.all([
...
const embedded = { body, css, appJs, mapDataUrl, reimuSpriteDataUrl, reimuPortraitDataUrl, mainHouseDataUrl };
