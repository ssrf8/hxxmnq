...
本目录保存项目素材清理中迁出的历史、废弃、被拒绝或已被正式版本取代的素材。首次整理于 2026-07-29，最近一次增量整理于 2026-07-31。
...
| V3 地图换代 | 2026-07-31 将已被 `garden-base-owner-v3.png` 与 13 张 V3 设施形态取代的 V2 底图、V2 设施、V2 损坏覆盖层及其 chroma 维护源按原相对路径归档 |
| 退役主屋叠图 | 2026-07-31 将 4 张早已退出运行时的主屋损坏／修复透明贴图与 chroma 源归档；主屋状态逻辑继续保留，地图视觉直接使用 V3 底图中的中央主屋 |
