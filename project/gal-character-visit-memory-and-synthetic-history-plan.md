...
这 12 条不是“亲密行为记录额度”，而是每个角色独立的完整关系记忆库。它既记录当前关系是什么，也记录为什么会变成这样。
...
- 记录造成关系变化的关键事实；
- 例如“第 12 日，角色与玩家明确接吻”“第 18 日，双方发生亲密行为”“第 21 日，角色明确拒绝某项越界要求”“第 25 日，双方在争执后和解”；
...
- 亲密只写关系层面的中性梗概，不保存露骨动作流水账；
- 接吻或亲密不自动等于恋爱、专一、永久同意或未来行为授权；
...
只有已接受正文明确确认关系时才能接受 relationship_state；“发生接吻”或“发生亲密行为”本身只能先成为 milestone，不能被 Bridge 自动升级为 lover。
